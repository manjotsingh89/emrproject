...
GlobalConfig::$ROUTE_MAP = array(
    ...
    'GET:onsitedocumentsdemo' => array(
        'route' => 'OnsiteDocumentDemo.ListView',
        'p_acl' => 'p_all', // Secured this at downstream function level
        'p_reg' => false
    ),
    'GET:onsitedocumentstwo' => array(
        'route' => 'OnsiteDocumentTwo.ListView',
        'p_acl' => 'p_all', // Secured this at downstream function level
        'p_reg' => false
    ),
    'GET:onsitedocumentsthree' => array(
        'route' => 'OnsiteDocumentThree.ListView',
        'p_acl' => 'p_all', // Secured this at downstream function level
        'p_reg' => false
    ),
