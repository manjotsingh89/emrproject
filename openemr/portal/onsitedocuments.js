...
// page scoped functions
    ...
    questionnaireHistoryView: function () {
        var url = webRoot + '/portal/get_questionnaire.php';
        var html = $('.questionnaire-html').html();
        $('.doc-div').attr('style','display:none !important;');
        //window.location.href = 'https://emr.livebroadcast.co.za/openemr/portal/patient/onsitedocuments?pid=2';
    ...
    newDocument: function (pid, user, templateName, template_id) {
        $('.doc-div').attr('style','display:block !important;');
        $('.questionnaire-div').hide();
